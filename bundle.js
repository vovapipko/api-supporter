...
/******/ (() => {
  ...
  \***************************************************************/
    ...
    \***************************************************************************************/
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        /* harmony import */ var _model_model_autocomplete__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ../../../model/model-autocomplete */ "./src/model/model-autocomplete.js"
          );
        /* harmony import */ var _model_model_list__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(/*! ../../../model/model-list */ "./src/model/model-list.js");
        /* harmony import */ var _model_model_position__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(/*! ../../../model/model-position */ "./src/model/model-position.js");
        /* harmony import */ var _checkbox_template__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(
            /*! ../checkbox-template */ "./src/components/api-components/checkbox-template.js"
          );
        /* harmony import */ var _list_template__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          /*! ../list-template */ "./src/components/api-components/list-template.js"
        );
        /* harmony import */ var _number_template__WEBPACK_IMPORTED_MODULE_6__ =
          __webpack_require__(
            /*! ../number-template */ "./src/components/api-components/number-template.js"
          );
        /* harmony import */ var _radio_template__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
          /*! ../radio-template */ "./src/components/api-components/radio-template.js"
        );
        /* harmony import */ var _text_teplate__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
          /*! ../text-teplate */ "./src/components/api-components/text-teplate.js"
        );
        var getAutocompleteTemplate = function getAutocompleteTemplate() {
          var j = _model_model_autocomplete__WEBPACK_IMPORTED_MODULE_1__.parameterAutocomplete.st,
            k =
              _model_model_autocomplete__WEBPACK_IMPORTED_MODULE_1__.parameterAutocomplete.strategy,
            l = _model_model_autocomplete__WEBPACK_IMPORTED_MODULE_1__.parameterAutocomplete.apiKey,
            m =
              _model_model_autocomplete__WEBPACK_IMPORTED_MODULE_1__.parameterAutocomplete.shuffle,
            n =
              _model_model_autocomplete__WEBPACK_IMPORTED_MODULE_1__.parameterAutocomplete
                .productsSize,
            o =
              _model_model_autocomplete__WEBPACK_IMPORTED_MODULE_1__.parameterAutocomplete.regionId,
            p = _model_model_autocomplete__WEBPACK_IMPORTED_MODULE_1__.parameterAutocomplete.forIs,
            q =
              _model_model_autocomplete__WEBPACK_IMPORTED_MODULE_1__.parameterAutocomplete
                .showUnavailable,
            r =
            ...
            s =
              _model_model_autocomplete__WEBPACK_IMPORTED_MODULE_1__.parameterAutocomplete
                .withContent,
            t =
              _model_model_autocomplete__WEBPACK_IMPORTED_MODULE_1__.parameterAutocomplete.withSku;
          return '<div class="api" '
            .concat(
              _model_model_position__WEBPACK_IMPORTED_MODULE_3__.positionSort.top &&
                _model_model_position__WEBPACK_IMPORTED_MODULE_3__.positionSort.left
                ? 'style="left: '
                    .concat(
                      _model_model_position__WEBPACK_IMPORTED_MODULE_3__.positionSort.left,
                      "px; top: "
            ...
            .concat(
              (0, _radio_template__WEBPACK_IMPORTED_MODULE_7__.getRadioTemplate)(
                _const__WEBPACK_IMPORTED_MODULE_0__.RadioTemplateOption.TYPE
              ),
              "\n                "
            )
            .concat(
              (0, _text_teplate__WEBPACK_IMPORTED_MODULE_8__.getTextTemplate)(j),
              "\n                "
            )
            .concat(
              (0, _text_teplate__WEBPACK_IMPORTED_MODULE_8__.getTextTemplate)(l),
              "\n                <hr />\n                "
            )
            .concat(
              (0, _checkbox_template__WEBPACK_IMPORTED_MODULE_4__.getCheckboxTemplate)(m, "hidden"),
              "\n                "
            )
            .concat(
              (0, _checkbox_template__WEBPACK_IMPORTED_MODULE_4__.getCheckboxTemplate)(p),
              "\n                "
            )
            .concat(
              (0, _checkbox_template__WEBPACK_IMPORTED_MODULE_4__.getCheckboxTemplate)(s, "hidden"),
              "\n                "
            )
            .concat(
              (0, _checkbox_template__WEBPACK_IMPORTED_MODULE_4__.getCheckboxTemplate)(t),
              "\n                "
            )
            .concat(
              (0, _number_template__WEBPACK_IMPORTED_MODULE_6__.getNumberTemplate)(n, 5),
              "\n                <hr />\n                "
            )
            .concat(
              (0, _list_template__WEBPACK_IMPORTED_MODULE_5__.getListTemplate)(
                _model_model_list__WEBPACK_IMPORTED_MODULE_2__.listSort.availability,
                [
                  (0, _checkbox_template__WEBPACK_IMPORTED_MODULE_4__.getCheckboxTemplate)(q),
                  (0, _number_template__WEBPACK_IMPORTED_MODULE_6__.getNumberTemplate)(r),
                ]
              ),
              "\n                <hr />\n                \n                "
            )
            .concat(
              (0, _list_template__WEBPACK_IMPORTED_MODULE_5__.getListTemplate)(
                _model_model_list__WEBPACK_IMPORTED_MODULE_2__.listSort.other,
                [
                  (0, _radio_template__WEBPACK_IMPORTED_MODULE_7__.getRadioTemplate)(
                    _const__WEBPACK_IMPORTED_MODULE_0__.RadioTemplateOption.STRATEGY,
                    k
                  ),
                  (0, _radio_template__WEBPACK_IMPORTED_MODULE_7__.getRadioTemplate)(
                    _const__WEBPACK_IMPORTED_MODULE_0__.RadioTemplateOption.EXTRA_STRATEGY,
                    k
                  ),
                  (0, _text_teplate__WEBPACK_IMPORTED_MODULE_8__.getTextTemplate)(k),
                  (0, _text_teplate__WEBPACK_IMPORTED_MODULE_8__.getTextTemplate)(o),
                ]
              ),
              "\n            </form>\n        </div>"
            );
      ...
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        var getCheckboxTemplate = function getCheckboxTemplate(b) {
          var c = 1 < arguments.length && arguments[1] !== void 0 ? arguments[1] : "",
            ...
            f = b.value,
            g = b.description,
            h = (0, _utils__WEBPACK_IMPORTED_MODULE_0__.formatFieldTitle)(g),
            i = "true" === f ? "checked" : "";
          return '<div class="form__field form__field--toggle" '
            .concat(c ? 'style="display: none;"' : "", '>\n      <span class="field__title">')
            .concat(
              (0, _utils__WEBPACK_IMPORTED_MODULE_0__.formatFieldTitle)(d),
              ':</span>\n      <span data-tooltip="'
            )
            .concat(
              h,
    ...
    \**********************************************************/
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        var getNumberTemplate = function getNumberTemplate(b) {
          var c = 1 < arguments.length && arguments[1] !== void 0 ? arguments[1] : 20,
            d = b.key,
            e = b.type,
            f = b.value,
            g = f || "unavailableMultiplier" !== d ? f || c : "0.01";
    ...
    \*********************************************************/
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        var h = function getTypes() {
          return (0, _utils__WEBPACK_IMPORTED_MODULE_1__.getHost)() ===
            _const__WEBPACK_IMPORTED_MODULE_0__.AppType.SORT ||
            (0, _utils__WEBPACK_IMPORTED_MODULE_1__.getHost)() ===
              _const__WEBPACK_IMPORTED_MODULE_0__.AppType.SORT_QA
            ? _const__WEBPACK_IMPORTED_MODULE_0__.AppType.SORT
            : _const__WEBPACK_IMPORTED_MODULE_0__.AppType.AUTOCOMPLETE;
        };
        var getRadioTemplate = function getRadioTemplate(g) {
          var i = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : "",
            j =
              h() === _const__WEBPACK_IMPORTED_MODULE_0__.AppType.SORT
                ? _const__WEBPACK_IMPORTED_MODULE_0__.SORT_TYPES
                : _const__WEBPACK_IMPORTED_MODULE_0__.AUTOCOMPLETE_TYPES,
            k = "",
            l = '<span class="field__title">API:</span>';
          return (
            g === _const__WEBPACK_IMPORTED_MODULE_0__.RadioTemplateOption.STRATEGY &&
              ((j = _const__WEBPACK_IMPORTED_MODULE_0__.STRATEGIES),
              (k = "form__field--strategy"),
              (l = "")),
            g === _const__WEBPACK_IMPORTED_MODULE_0__.RadioTemplateOption.EXTRA_STRATEGY &&
              ((j = _const__WEBPACK_IMPORTED_MODULE_0__.EXTRA_STRATEGIES),
              (k = "form__field--extra-strategy"),
              (l = "")),
            '<div \n            class="form__field '
              .concat(k, '">\n            ')
              .concat(l, "\n            ")
    ...
    \**********************/
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        var AUTOCOMPLETE_TYPES = ["autocomplete"];
        ...
        var AppType = {
          ...
          AUTOCOMPLETE_QA: "autocomplete-qa",
        };
    ...
    \********************************************/
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        /* harmony import */ var _components_api_components_aply_button_template__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ../components/api-components/aply-button-template */ "./src/components/api-components/aply-button-template.js"
          );
        /* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ../const */ "./src/const.js"
        );
        /* harmony import */ var _model_model_autocomplete__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ../model/model-autocomplete */ "./src/model/model-autocomplete.js"
          );
        /* harmony import */ var _model_model_sort__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(/*! ../model/model-sort */ "./src/model/model-sort.js");
        /* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ../utils */ "./src/utils.js"
        );
        var n = function getParameterApi() {
            return (0, _utils__WEBPACK_IMPORTED_MODULE_4__.getHost)() ===
              _const__WEBPACK_IMPORTED_MODULE_1__.AppType.SORT ||
              (0, _utils__WEBPACK_IMPORTED_MODULE_4__.getHost)() ===
                _const__WEBPACK_IMPORTED_MODULE_1__.AppType.SORT_QA
              ? _model_model_sort__WEBPACK_IMPORTED_MODULE_3__.parameterSort
              : _model_model_autocomplete__WEBPACK_IMPORTED_MODULE_2__.parameterAutocomplete;
          },
          o = n(),
          p = function renderApplyButton(b) {
            var c = b.closest("form").getBoundingClientRect(),
              d = b.nextElementSibling
                ? b.nextElementSibling.getBoundingClientRect()
                : b.getBoundingClientRect();
            (0, _utils__WEBPACK_IMPORTED_MODULE_4__.render)(
              _const__WEBPACK_IMPORTED_MODULE_1__.rootElement,
              (0,
              _components_api_components_aply_button_template__WEBPACK_IMPORTED_MODULE_0__.getApplyButtonTemplate)(
                c,
                d
              )
            );
          },
          q = function checkFormValid(a) {
            for (var b, c = 0; c < a.length; c += 1)
              if (
                ((b = document.querySelector("input[name=".concat(a[c], "]"))),
                o[a[c]].required && !b.value)
              )
                return { isValid: !1, inputElement: b };
            return { isValid: !0 };
          },
          r = function addErrorMessage(a) {
            var b = a.inputElement,
              c = b.placeholder;
            if (b.classList.contains("field__text--input-error"))
              return (
                b.focus(),
                (0, _utils__WEBPACK_IMPORTED_MODULE_4__.removeElement)(".apply-filters"),
                p(b),
                !1
              );
            var d = !1,
          ...
          s = function collectSearchLink(a) {
            ...
            return a
              .reduce(function (a, d) {
                var f = document.querySelector("input[name=".concat(d, "]"));
                return f || "key" === o[d].key
                  ? f && ("text" === f.type || "number" === f.type) && (f.value || "st" === d)
                    ? "".concat(a).concat(d, "=").concat(f.value.replace(/&/g, "%26"), "&")
                    : f && "checkbox" === f.type
                    ? "".concat(a).concat(d, "=").concat(f.checked, "&")
                    : f &&
                      "radio" === f.type &&
                      f.name === _const__WEBPACK_IMPORTED_MODULE_1__.RadioTemplateOption.STRATEGY
                    ? "".concat(a).concat(d, "=").concat(c(f), "&")
                    : o[d].value &&
                      "key" === o[d].key && // window.location.pathname.match(SORT_TYPES[0])
                      b !== _const__WEBPACK_IMPORTED_MODULE_1__.SORT_TYPES[0]
                    ? "".concat(a).concat(d, "=").concat(o[d].value, "&")
                    : "".concat(a)
                  : o[d].value
                  ? "".concat(a).concat(d, "=").concat(o[d].value, "&")
                  : "".concat(a);
          ...
          t = function checkDebugKey() {
            var a = o.key,
              b = document.querySelector(
                "[value=".concat(_const__WEBPACK_IMPORTED_MODULE_1__.SORT_TYPES[0], "]")
              );
            if (!a.value) {
              /* eslint-disable */ var c = prompt(
                "\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043A\u043B\u044E\u0447",
                ""
              );
              /* eslint-enable */ if (null === c) return (b.checked = !0), !1;
              if ("h" === c[1] && "s" === c[c.length - 1])
                return (
          ...
          u = function submitForm(a) {
            ...
            if (!c.isValid) r(c);
              ...
              if (
                d === _const__WEBPACK_IMPORTED_MODULE_1__.SORT_TYPES[0] ||
                (d === _const__WEBPACK_IMPORTED_MODULE_1__.SORT_TYPES[1] && t())
              ) {
                var f = s(b, d);
                window.history.pushState("", "", f), (window.location.pathname = d);
              }
            } else {
              var h = s(b);
        ...
        var handleFormInput = function handleFormInput(a) {
          (0, _utils__WEBPACK_IMPORTED_MODULE_4__.removeElement)(".apply-filters"), p(a.target);
        ...
        var handleFormKeyup = function handleFormKeyup(a) {
          var b = a.keyCode;
          b === _const__WEBPACK_IMPORTED_MODULE_1__.KeyCode.ENTER && u();
        };
    ...
    \*****************************************/
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        var parameterAutocomplete = {
          st: {
            key: "st",
            type: "text",
            value: (0, _utils__WEBPACK_IMPORTED_MODULE_0__.getParameterByName)("st"),
            description:
              "\u041F\u043E\u0438\u0441\u043A\u043E\u0432\u044B\u0439 \u0437\u0430\u043F\u0440\u043E\u0441",
            placeholder:
              "\u041F\u043E\u0438\u0441\u043A\u043E\u0432\u044B\u0439 \u0437\u0430\u043F\u0440\u043E\u0441",
          ...
          apiKey: {
            key: "apiKey",
            type: "text",
            value: (0, _utils__WEBPACK_IMPORTED_MODULE_0__.getParameterByName)("apiKey"),
          ...
          strategy: {
            key: "strategy",
            type: "text",
            value: (0, _utils__WEBPACK_IMPORTED_MODULE_0__.getParameterByName)("strategy")
              ? (0, _utils__WEBPACK_IMPORTED_MODULE_0__.getParameterByName)("strategy")
              : "simple",
            description:
          ...
          shuffle: {
            ...
            value:
              null === window.location.pathname.match(/debug/)
                ? (0, _utils__WEBPACK_IMPORTED_MODULE_0__.getParameterByName)("shuffle")
                : "false",
            description:
              "\u0424\u043B\u0430\u0433 \u043D\u0435 \u0440\u0430\u0431\u043E\u0442\u0430\u0435\u0442, \u0440\u0430\u043D\u044C\u0448\u0435 \u043F\u0435\u0440\u0435\u0442\u0430\u0441\u043E\u0432\u044B\u0432\u0430\u043B \u043F\u043E\u043F\u0443\u043B\u044F\u0440\u043D\u044B\u0435 \u0442\u043E\u0432\u0430\u0440\u044B \u043F\u0440\u0438 \u043F\u0443\u0441\u0442\u043E\u043C \u0437\u0430\u043F\u0440\u043E\u0441\u0435",
            required: !1,
          },
          productsSize: {
            key: "productsSize",
            type: "number",
            value: (0, _utils__WEBPACK_IMPORTED_MODULE_0__.getParameterByName)("productsSize"),
            description:
              "\u041A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u043E \u0442\u043E\u0432\u0430\u0440\u043E\u0432, \u043A\u043E\u0442\u043E\u0440\u043E\u0435 \u0432\u0435\u0440\u043D\u0451\u0442\u0441\u044F \u0432 \u043E\u0442\u0432\u0435\u0442\u0435. \u0417\u043D\u0430\u0447\u0435\u043D\u0438\u0435 \u043F\u043E \u0443\u043C\u043E\u043B\u0447\u0430\u043D\u0438\u044E - 10, \u0430 \u043C\u0430\u043A\u0441\u0438\u043C\u0443\u043C 100",
            required: !1,
          },
          regionId: {
            key: "regionId",
            type: "text",
            value: (0, _utils__WEBPACK_IMPORTED_MODULE_0__.getParameterByName)("regionId"),
            description:
          ...
          forIs: {
            ...
            value:
              null === window.location.pathname.match(/debug/)
                ? (0, _utils__WEBPACK_IMPORTED_MODULE_0__.getParameterByName)("forIs")
                : "false",
            description:
              "\u0424\u043B\u0430\u0433 \u043E\u0442\u0432\u0435\u0447\u0430\u0435\u0442 \u0437\u0430 \u043F\u043E\u0438\u0441\u043A \u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u0439 \u043F\u043E \u0438\u0445 \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u044F\u043C. \u041F\u0440\u0438 \u0437\u043D\u0430\u0447\u0435\u043D\u0438\u0438 false, \u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u0438 \u043F\u043E \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u044E \u0438\u0449\u0443\u0442\u0441\u044F",
            required: !1,
          },
          showUnavailable: {
            key: "showUnavailable",
            type: "checkbox",
            value: (0, _utils__WEBPACK_IMPORTED_MODULE_0__.getParameterByName)("showUnavailable"),
            description:
          ...
          unavailableMultiplier: {
            ...
            type: "number",
            value: (0, _utils__WEBPACK_IMPORTED_MODULE_0__.getParameterByName)(
              "unavailableMultiplier"
            ),
            description:
          ...
          withContent: {
            key: "withContent",
            type: "checkbox",
            value: (0, _utils__WEBPACK_IMPORTED_MODULE_0__.getParameterByName)("withContent"),
            description:
              "\u041F\u043E\u043A\u0430\u0437\u044B\u0432\u0430\u0442\u044C \u043B\u0438 \u0432 \u043F\u043E\u0434\u0441\u043A\u0430\u0437\u043A\u0430\u0445 \u0441\u0441\u044B\u043B\u043A\u0438 \u043D\u0430 \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u044B \u0441 \u043A\u043E\u043D\u0442\u0435\u043D\u0442\u043E\u043C, \u0441\u0442\u0430\u0442\u044C\u0438",
            required: !1,
          },
          withSku: {
            key: "withSku",
            ...
            value:
              null === window.location.pathname.match(/debug/)
                ? (0, _utils__WEBPACK_IMPORTED_MODULE_0__.getParameterByName)("withSku")
                : "false",
            description:
              "\u041E\u0442\u043E\u0431\u0440\u0430\u0436\u0430\u0442\u044C \u043B\u0438 \u0433\u0440\u0443\u043F\u043F\u044B \u0442\u043E\u0432\u0430\u0440\u043E\u0432. \u0414\u043B\u044F \u043A\u043B\u0438\u0435\u043D\u0442\u043E\u0432 \u0443 \u043A\u043E\u0442\u043E\u0440\u044B\u0445 Groupid deduplication \u043D\u0435 \u0432\u043A\u043B\u044E\u0447\u0435\u043D\u0430, \u0437\u043D\u0430\u0447\u0435\u043D\u0438\u0435 \u0444\u043B\u0430\u0433\u0430 \u043D\u0435 \u0432\u043B\u0438\u044F\u0435\u0442 \u043D\u0430 \u0432\u044B\u0434\u0430\u0447\u0443",
            required: !1,
          },
        };
  ...
  (() => {
    ...
    /* harmony import */ var _controllers_form_controller__WEBPACK_IMPORTED_MODULE_4__ =
      __webpack_require__(
        /*! ./controllers/form-controller */ "./src/controllers/form-controller.js"
      );
    ...
    /* harmony import */ var _components_api_components_autocomplete_templates_autocomplete_template__WEBPACK_IMPORTED_MODULE_7__ =
      __webpack_require__(
        /*! ./components/api-components/autocomplete-templates/autocomplete-template */ "./src/components/api-components/autocomplete-templates/autocomplete-template.js"
      );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.createStyleApp)(
      _styles__WEBPACK_IMPORTED_MODULE_1__.styleApi
    );
    var o = function renderSort() {
      ...
      p = function renderAutocomplete() {
        (0, _utils__WEBPACK_IMPORTED_MODULE_0__.render)(
          _const__WEBPACK_IMPORTED_MODULE_2__.rootElement,
          (0,
          _components_api_components_autocomplete_templates_autocomplete_template__WEBPACK_IMPORTED_MODULE_7__.getAutocompleteTemplate)()
        );
      },
      q = function setFormHandlers() {
        var b = document.querySelector("#api__form");
        b.addEventListener(
          "keyup",
          _controllers_form_controller__WEBPACK_IMPORTED_MODULE_4__.handleFormKeyup
        );
        var c = document.querySelectorAll("input:not([type=radio])"),
          d = document.querySelectorAll("input[type=radio]");
        (0, _utils__WEBPACK_IMPORTED_MODULE_0__.addEventListenerAll)(
          c,
          "input",
          _controllers_form_controller__WEBPACK_IMPORTED_MODULE_4__.handleFormInput
        ),
          (0, _utils__WEBPACK_IMPORTED_MODULE_0__.addEventListenerAll)(
            d,
            "change",
            _controllers_form_controller__WEBPACK_IMPORTED_MODULE_4__.handleFormRadioChange
          );
        var e = document.querySelector(".navigation__drag");
        e.addEventListener(
          "mousedown",
          _controllers_drag_drop_controller__WEBPACK_IMPORTED_MODULE_5__.handleFormDragDrop
        );
        var f = document.querySelectorAll(".form__list .list__header");
        (0, _utils__WEBPACK_IMPORTED_MODULE_0__.addEventListenerAll)(
          f,
          "click",
    ...
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.getHost)() ===
      _const__WEBPACK_IMPORTED_MODULE_2__.AppType.SORT ||
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.getHost)() ===
      _const__WEBPACK_IMPORTED_MODULE_2__.AppType.SORT_QA
      ? (o(), q())
      : ((0, _utils__WEBPACK_IMPORTED_MODULE_0__.getHost)() ===
          _const__WEBPACK_IMPORTED_MODULE_2__.AppType.AUTOCOMPLETE ||
          (0, _utils__WEBPACK_IMPORTED_MODULE_0__.getHost)() ===
            _const__WEBPACK_IMPORTED_MODULE_2__.AppType.AUTOCOMPLETE_QA) &&
        (p(), q());
  })();
