/******/ (() => {
  ...
  \*************************************************/
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        var d = function getDragElement(a) {
          return a.classList.contains("api__header") || a.closest(".api__header")
            ? a.closest(".api")
            : null;
        };
        var handleFormDragDrop = function handleFormDragDrop(e) {
          var f = e.target,
            g = e.offsetX,
            h = e.offsetY;
          f.style.cursor = "grabbing";
          var i = d(f),
            j = function handleFormMousemove(a) {
              var d = a.x,
                e = a.y;
              (0, _utils__WEBPACK_IMPORTED_MODULE_2__.removeElement)(".apply-filters"),
                (i.style.left = "".concat(d - g, "px")),
                (_model_model_position__WEBPACK_IMPORTED_MODULE_1__.positionSort.left = d - g),
                (i.style.top = "".concat(e - h, "px")),
                (_model_model_position__WEBPACK_IMPORTED_MODULE_1__.positionSort.top = e - h);
      ...
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        var k = function renderApplyButton(b) {
          ...
          n = function collectSearchLink(a) {
            var b = function collectStrategy() {
            ...
            return a
              .reduce(function (a, c) {
                var e = document.querySelector("input[name=".concat(c, "]"));
                return e
                  ? e && ("text" === e.type || "number" === e.type) && e.value
                    ? "".concat(a).concat(c, "=").concat(e.value, "&")
                    : e && "checkbox" === e.type
                    ? "".concat(a).concat(c, "=").concat(e.checked, "&")
                    : e &&
                      "radio" === e.type &&
                      e.name === _const__WEBPACK_IMPORTED_MODULE_1__.RadioTemplateOption.STRATEGY
                    ? "".concat(a).concat(c, "=").concat(b(e), "&")
                    : _model_model_sort__WEBPACK_IMPORTED_MODULE_2__.parameterSort[c].value &&
                      "key" !== _model_model_sort__WEBPACK_IMPORTED_MODULE_2__.parameterSort[c].key
                    ? ""
                        .concat(a)
                        .concat(c, "=")
                        .concat(
  ...
  \**********************/
    ...
    var l = document.querySelector("#api__form");
    l.addEventListener(
      "keyup",
      _controllers_sort_form_controller__WEBPACK_IMPORTED_MODULE_4__.handleFormKeyup
    );
    var m = document.querySelectorAll("input:not([type=radio])"),
    ...
    var o = document.querySelector(".api__header");
    o.addEventListener(
      "mousedown",
